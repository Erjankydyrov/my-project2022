...
function Home() {
  return (
    <>
      <Header title="Welcome to our coffee shop!" image={headerImage}>
        ...
        so-called stone fruit. Even though the coffee beans are not technically
        beans, they are referred to as such because of their resemblance to true
        beans.
      </Header>
    </>
  );
